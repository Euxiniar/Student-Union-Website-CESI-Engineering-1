    ...
    <form class="container-fluid" method="post"  autocomplete="on" enctype="multipart/form-data">
        ...
        <div class="row">
            ...
            <div class="col-md-4"> <!--Titre date récurrence-->
                ...
                <input class="form-control" type="text" name="title" placeholder="Titre de l'évènement" required autofocus>
        ...
        <div class="row">
            <div class="col-md-12"> <!--Boutton submit-->
                <div class="submit">
                    ...
                    <a href="../events_to_come/index.php" id="submit" name="submit" class="btn btn-danger m-3" >Annuler</a>
